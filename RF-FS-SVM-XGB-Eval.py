...
for model_name, config in EVAL_CONFIGS.items():
    ...
    for r in range(N_REPEATS):
        ...
        for fold_idx, (train_idx, test_idx) in enumerate(outer_cv.split(X, y)):
            ...
            # Scale for consistency across downstream classifiers
...
for m in EVAL_CONFIGS:
    print(f"  RF_Selection_{m}_Evaluation_Summary.csv")
    print(f"  RF_Selection_{m}_Fold_Metrics.csv")
    print(f"  RF_Selection_{m}_ROC_Data.csv")
    print(f"  RF_Selection_{m}_Param_Frequencies.txt")
