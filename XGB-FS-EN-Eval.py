...
# EN evaluator search space (identical to EN_FS_EN config)
EN_EVAL_PARAM_DIST = {
...
for r in range(N_REPEATS):
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(outer_cv.split(X, y)):
        ...
        eval_search = RandomizedSearchCV(
            LogisticRegression(**EN_EVAL_FIXED),
            param_distributions=EN_EVAL_PARAM_DIST,
...
with open(f'XGB_Selection_EN_Param_Frequencies.txt', 'w') as f:
    f.write(f"EN Evaluator Parameter Frequency Analysis\n")
